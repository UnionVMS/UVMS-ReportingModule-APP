...
public class ReportMapperV2Test {
    ...
    public void testReportDtoToReport(){
        ...
        Report report = ReportMapperV2.INSTANCE.reportDtoToReport(mapper.readValue(expectedJSONString, eu.europa.ec.fisheries.uvms.reporting.dto.report.Report.class));
