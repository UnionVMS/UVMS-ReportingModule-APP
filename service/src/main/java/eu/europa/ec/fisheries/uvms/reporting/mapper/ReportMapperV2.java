...
import eu.europa.ec.fisheries.uvms.reporting.dto.Asset;
...
public abstract class ReportMapperV2 {
    ...
    public abstract Report reportDtoToReport(eu.europa.ec.fisheries.uvms.reporting.dto.report.Report dto);

    public abstract eu.europa.ec.fisheries.uvms.reporting.dto.report.Report reportToReportDto(final Report entity); // TODO test if same as in mapper V1

    Set<Filter> mapFilters(eu.europa.ec.fisheries.uvms.reporting.dto.report.Report dto){
