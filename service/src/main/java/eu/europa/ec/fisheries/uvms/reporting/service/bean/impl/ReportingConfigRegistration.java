...
@Stateless
public class ReportingConfigRegistration implements ConfigHelper {
    ...
    @PersistenceContext(unitName = "reportingConfig")
    private EntityManager em;

    @Override
    public List<String> getAllParameterKeys() {
        return Collections.singletonList("reporting.parameter.key");
    }
