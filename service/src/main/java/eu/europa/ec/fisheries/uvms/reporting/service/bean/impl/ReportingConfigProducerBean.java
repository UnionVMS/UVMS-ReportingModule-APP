...
@Stateless
@Slf4j
public class ReportingConfigProducerBean extends AbstractProducer implements ConfigMessageProducer {

    private Queue reportingINQueue;

    @PostConstruct
    public void init(){
        reportingINQueue = JMSUtils.lookupQueue(MessageConstants.QUEUE_REPORTING);
    }
