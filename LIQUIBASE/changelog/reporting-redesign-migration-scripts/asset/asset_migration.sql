...
select ah.assethist_id,aa.asset_guid,ah.assethist_active,ah.assethist_uvi,ah.assethist_iccat,ah.assethist_cfr,ah.assethist_ircs,ah.assethist_nameowner,ah.assethist_externalmarking,ah.assethist_gfcm,ah.assethist_countryregistration,ah.assethist_loa,fgt.fishgtyp_desc
