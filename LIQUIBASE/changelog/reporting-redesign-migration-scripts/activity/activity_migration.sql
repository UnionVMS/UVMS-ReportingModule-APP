...
select distinctfc.id,fc.fishing_activity_id,fc.species_code,fc.gear_type_code,fc.species_code,aap.calculated_weight_measure,aap.weight_measure_unit_code,asdc.class_code,asd.category_code,aap.calculated_unit_quantity
